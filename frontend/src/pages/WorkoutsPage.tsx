...
export default function WorkoutsPage() {
  ...
  const logSet = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["sessions"] });
      // The progress tracker caches per exercise; without this a set logged
      // here doesn't show up on that page until a full reload.
      queryClient.invalidateQueries({ queryKey: ["progress"] });
      // A heavy set may have just become a personal record, and the
      // celebration is worth showing while they are still standing there.
  ...
  return (
    <div>
      ...
      {/* Renders nothing unless a record is genuinely waiting. */}
